...
export const LandingPage: React.FC<LandingPageProps> = ({ onLaunch }) => {
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-zinc-950 text-zinc-100 flex flex-col font-sans selection:bg-orange-900 selection:text-orange-100 overflow-x-hidden">
      ...
      {/* Navigation */}
      <nav className="w-full max-w-7xl mx-auto px-6 h-20 sm:h-24 flex items-center justify-between relative z-50">
        <div className="flex items-center gap-3">
            <div className="relative group cursor-pointer" onClick={onLaunch}>
                ...
                <div className="relative bg-gradient-to-br from-orange-500 to-red-600 p-2 rounded-xl border border-white/10 shadow-lg shadow-orange-900/20">
      ...
      <main className="flex-1 w-full">
        {/* Hero Section */}
        <section className="relative pt-20 pb-32 px-6 flex flex-col items-center text-center overflow-hidden min-h-[80vh] justify-center">
             {/* Background Gradients */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] sm:w-[900px] sm:h-[900px] bg-orange-600/10 blur-[80px] sm:blur-[120px] rounded-full pointer-events-none mix-blend-screen"></div>
            ...
            {/* Headline */}
            <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold tracking-tighter text-white mb-10 relative z-10 max-w-6xl mx-auto leading-[0.95] sm:leading-[0.9] drop-shadow-2xl">
            ...
            {/* Subheadline */}
            <p className="text-lg sm:text-xl text-zinc-400 max-w-2xl mx-auto mb-12 leading-relaxed relative z-10 font-light tracking-wide">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5 relative z-10 w-full sm:w-auto">
             ...
             {/* Footer-ish info moved into Hero */}
        ...
        {/* Features Section */}
        <section className="py-24 sm:py-32 relative z-10 bg-zinc-950/50 border-t border-zinc-900">
             <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Built for Creators</h2>
                    <p className="text-zinc-400 max-w-2xl mx-auto">Everything you need to grab the perfect still from your footage, designed for speed and privacy.</p>
                </div>
      ...
      {/* Footer */}
      <footer className="border-t border-zinc-900 bg-zinc-950 py-12 sm:py-16 relative z-20">
