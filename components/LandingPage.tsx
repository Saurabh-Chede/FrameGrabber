...
export const LandingPage: React.FC<LandingPageProps> = ({ onLaunch }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-zinc-950 text-zinc-100 flex flex-col font-sans selection:bg-orange-900 selection:text-orange-100 overflow-x-hidden">
      ...
      {/* Hero Section */}
      <main className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 pb-12 sm:pb-20 text-center relative w-full max-w-[100vw]">
