...
export const LandingPage: React.FC<LandingPageProps> = ({ onLaunch }) => {
  ...
  return (
    <div className="h-[100dvh] w-full bg-zinc-950 text-zinc-100 flex flex-col font-sans selection:bg-orange-900 selection:text-orange-100 overflow-x-hidden overflow-y-auto">
      ...
      {/* Navigation */}
      <nav className="w-full max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 mt-0.5 sm:mt-0 flex items-center justify-between relative z-50 shrink-0">
      ...
      {/* Hero Section */}
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-5 sm:px-6 lg:py-8 xl:py-8 text-center relative w-full max-w-[100vw]">
        ...
        <div className="mt-20 pb-2 opacity-40 hover:opacity-100 transition-opacity duration-500 relative z-10">
